...
The latest stable release of citygml-tools is 2.5.0.
...
Replace the `TAG` label with the version of citygml-tools you want to use such as `v2.5.0`. The `latest` tag
