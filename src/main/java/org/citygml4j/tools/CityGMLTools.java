...
import org.citygml4j.tools.command.appearance.RemoveAppsCommand;
import org.citygml4j.tools.command.appearance.ToLocalAppsCommand;
import org.citygml4j.tools.command.cityjson.FromCityJSONCommand;
import org.citygml4j.tools.command.cityjson.ToCityJSONCommand;
import org.citygml4j.tools.command.height.ChangeHeightCommand;
import org.citygml4j.tools.command.lod.FilterLodsCommand;
import org.citygml4j.tools.command.merge.MergeCommand;
import org.citygml4j.tools.command.reproject.ReprojectCommand;
import org.citygml4j.tools.command.statistics.StatsCommand;
import org.citygml4j.tools.command.subset.SubsetCommand;
import org.citygml4j.tools.command.textures.ClipTexturesCommand;
import org.citygml4j.tools.command.upgrade.UpgradeCommand;
import org.citygml4j.tools.command.validate.ValidateCommand;
import org.citygml4j.tools.command.xslt.ApplyXSLTCommand;
    ...
    public String[] getVersion() {
        try (InputStream stream = getClass().getResourceAsStream("/org/citygml4j/tools/application.properties")) {
            ...
            return new String[]{
                    ...
                    "Copyright (C) 2018-" + LocalDate.now().getYear() + " Claus Nagel <claus.nagel@gmail.com>\n"
            };
        } catch (IOException e) {
            return new String[]{};
        }
